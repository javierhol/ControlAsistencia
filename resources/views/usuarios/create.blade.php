...
@section('content')
    <form id="usuario" class="form-horizontal form-label-left" autocomplete="off" novalidate method="POST"
        action="{{ url('usuarios') }}">
        @csrf
        ...
        <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="user_id_number">Documento <span
                    class="required">*</span>
            </label>
        ...
        <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first_name">Nombres <span
                    class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last_name">Apellidos <span
                    class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="last_name" name="last_name" type="text" required="required"
                    ...
                    placeholder="Ingrese Apellidos" value="{{ old('last_name') }}">
                @error('last_name')
                    <ul class="parsley-errors-list filled" id="parsley-id-1">
                        <li class="parsley-required">*{{ $message }}</li>
                    </ul>
        ...
        <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="user_type_id">Tipo Usuario <span
                    class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
